#include <stdio.h> //inclusão das bibliotecas, math.h será a biblioteca que nos permitira ver o valor absoluto da diferença entre dois numeros
#include <math.h>

int main(){
	int cont, MaiorAB, a, b, c; //Declaração de variaveis 
	
	scanf("%d %d %d", &a, &b, &c); //Leitura dos valores armazenados nas variaveis
	...
	printf("%d eh o maior\n", MaiorAB); // impressão na tela do maior valor entre os 3 digitados
